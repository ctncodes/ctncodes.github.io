...
function draw() {
  ...
  worldView(915.5, (screen.height)/2 + 150, "optimism", 'blue', 0);
  worldView(275.5, (screen.height)/2 + 150, "pessimism", 'red', 1);
  worldView(915.5, (screen.height)/2 + 190, "optimism", 'blue', 2);
  worldView(275.5, (screen.height)/2 + 190, "pessimism", 'red', 3);
  worldView(915.5, (screen.height)/2 + 230, "optimism", 'blue', 4);
  worldView(275.5, (screen.height)/2 + 230, "pessimism", 'red', 5);
}
